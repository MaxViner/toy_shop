...
public class ToyStore {
    ...
    public void modifyToy(int id) {
        ...
        if (toy == null) {
            System.out.println(" а нет такого...");
            return;
        }
        ...
        System.out.println("Toy modified successfully.");
    }

    public void run() {
        Scanner scanner = new Scanner(System.in);
        System.out.println("Приветствуем вас в магазине игрушек VinerMax! тут вы можете принять участие в розырыше игрушек.\n" +
                " Все безсплатно\n" +
                "Игрушки то тоже не настоящие\nЛол :Р");
        while (true) {
            ...
            if (choice == 2) {
                ...
                System.out.println("введи номер игрушки для модификации");
            ...
            if (choice == 1) {
                ...
                System.out.println("а призы фсе");
            }
            else {
